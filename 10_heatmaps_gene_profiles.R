#!/usr/bin/env Rscript
# =============================================================================
# GSE160299 DESeq2 Workflow — Step 10: Heatmaps and gene profiles
# =============================================================================
...
source("07_deseq2_model.R")
source("08_geo2r_qc_plots.R")
source("09_differential_expression.R")
...
message("[10_heatmaps_gene_profiles] Heatmaps and gene profile plots saved.")
